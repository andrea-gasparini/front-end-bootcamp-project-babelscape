...
{
    private _data : Array<Array<TableValue>>;
    private _dimensions : Dimension = new Dimension();
    private _firstRowHeader: boolean = true;
    private _alignText : Align = Align.CENTER;

    constructor(config: {data : Array<Array<TableValue>>, width? : number, height? : number, firstRowHeader? : boolean, alignText? : Align | string})
    {
    ...
    get data() : Array<Array<TableValue>> { return this._data; }
